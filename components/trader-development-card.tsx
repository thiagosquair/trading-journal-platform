...
interface TraderDevelopmentCardProps {
  icon: ReactNode
  title: string
  description: string
...
export default function TraderDevelopmentCard({
  icon,
  title,
  description,
  longDescription,
  className,
}: TraderDevelopmentCardProps) {
        ...
        {longDescription && (
          <div className="mt-4">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="text-indigo-600 p-0 h-auto font-medium flex items-center mt-2"
