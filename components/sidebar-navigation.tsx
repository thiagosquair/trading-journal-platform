      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive("/trading-accounts")}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive("/psychology")}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive("/ai-analysis")}>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive("/reports/performance")}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive("/reports/statements")}>
